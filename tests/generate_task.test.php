...
class Generate_Test extends PHPUnit_Framework_TestCase
{
    ...
    public function test_migration_sets_up_create_pivot()
    {
        $this->generate->migration(array(
        ...
        $this->assertContains("Schema::create('role_user'", $contents);
        $this->assertContains("Schema::drop('role_user')", $contents);

        $this->assertContains("\$table->increments('id')", $contents);
        $this->assertContains("\$table->boolean('status')", $contents);
        $this->assertContains("\$table->integer('role_id')->unsigned", $contents);
        $this->assertContains("\$table->integer('user_id')->unsigned", $contents);
        $this->assertContains("\$table->timestamps()", $contents);

        $this->assertContains("\$table->foreign('role_id')->references('id')->on('roles')->on_delete('cascade')->on_update('cascade')", $contents);
        $this->assertContains("\$table->foreign('user_id')->references('id')->on('users')->on_delete('cascade')->on_update('cascade')", $contents);
        $this->assertContains("\$table->drop_foreign('role_user_role_id_foreign')", $contents);
        $this->assertContains("\$table->drop_foreign('role_user_user_id_foreign')", $contents);
    }
